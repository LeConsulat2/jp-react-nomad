...
import CreateReviewDialog from '../components/create-review-dialogue';
...
export const loader = async ({ request, params }: Route.LoaderArgs) => {
  ...
  const reviews = await getReviews(client as any, Number(params.productId));
  return { reviews };
};
...
export const action = async ({ request, params }: Route.ActionArgs) => {
  ...
  await createProductReview(client as any, {
